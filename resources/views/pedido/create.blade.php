...
<form method="POST" action="{{ url('sys/pedidos/cadastrar') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control money" readonly id="valor_unitario" name="valor_unitario" value="{{old('valor_unitario')}}">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control money" readonly id="valor_total" name="valor_total" value="{{old('valor_total')}}">
  ...
  <a href="{{ url('sys/dashboard') }}" class="btn btn-primary">Voltar</a>
